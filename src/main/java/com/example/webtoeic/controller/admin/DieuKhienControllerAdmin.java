...
@RestController
@RequestMapping("/admin/IoT/dieukhien")
@PreAuthorize("hasRole('ROLE_ADMIN')")
public class DieuKhienControllerAdmin {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> createKhoiDieuKhien(
            @RequestParam("file") MultipartFile file,
            @RequestParam("tenKhoiDieuKhien") String tenKhoiDieuKhien,
        ...
        try {
            ...
            KhoiDieuKhienEntity khoiDieuKhienEntity = new KhoiDieuKhienEntity();
            khoiDieuKhienEntity.setAnhDieuKhien(BASE_UPLOAD_IMAGE_URL + fileName);
            khoiDieuKhienEntity.setTenDieuKhien(tenKhoiDieuKhien);
            khoiDieuKhienEntity.setContentHtml(docContentAsHtml);
            khoiDieuKhienEntity.setContentMarkDown(joinedImageNames);

            BaseResponse response = khoiDieuKhienService.save(khoiDieuKhienEntity);
    ...
    public ResponseEntity<?> updateKhoiDieuKhien(
            @PathVariable int id,
            @RequestParam("file") MultipartFile file,
            @RequestParam("tenKhoiDieuKhien") String tenKhoiDieuKhien,
            @RequestParam(value = "contentHTML", required = false) MultipartFile contentFile
    ) {
        BaseResponse fetchedKhoiDieuKhien = khoiDieuKhienService.getKhoiDieuKhien(id);
        ...
        try {
            ...
            BaseResponse updateResponse = khoiDieuKhienService.update(id, khoiDieuKhienEntity);
    ...
    public ResponseEntity<?> deleteKhoiDieuKhien(@PathVariable int id) {
        BaseResponse deleteResponse = khoiDieuKhienService.delete(id);
