...
@RestController
@RequestMapping("/admin/IoT/cambien")
@PreAuthorize("hasRole('ROLE_ADMIN')")
public class CamBienControllerAdmin {
    @Autowired
    ...
    public ResponseEntity<?> createKhoiCamBien(
            ...
            @RequestParam("tenKhoiCamBien") String tenKhoiCamBien,
        ...
        try {
            ...
            KhoiCamBienEntity khoiCamBienEntity = new KhoiCamBienEntity();
            khoiCamBienEntity.setAnhCamBien(BASE_UPLOAD_IMAGE_URL + fileName);
            khoiCamBienEntity.setTenCamBien(tenKhoiCamBien);
            khoiCamBienEntity.setContentHtml(docContentAsHtml);
            khoiCamBienEntity.setContentMarkDown(joinedImageNames);

            BaseResponse response = khoiCamBienService.save(khoiCamBienEntity);
    ...
    public ResponseEntity<?> updateKhoiCamBien(
            @PathVariable int id,
            @RequestParam("file") MultipartFile file,
            @RequestParam("tenKhoiCamBien") String tenKhoiCamBien,
        ...
        BaseResponse fetchedKhoiCamBien = khoiCamBienService.getKhoiCamBien(id);
        ...
        try {
            ...
            BaseResponse updateResponse = khoiCamBienService.update(id, khoiCamBienEntity);
    ...
    public ResponseEntity<?> deleteKhoiCamBien(@PathVariable int id) {
        BaseResponse deleteResponse = khoiCamBienService.delete(id);
